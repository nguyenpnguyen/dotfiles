---
description: Specialist in user interfaces and user experience design, expert at creating layouts, selecting colors and typography, or implementing visual designs
mode: subagent
---
...
2. Load `frontend-philosophy` and `code-philosophy` skill
